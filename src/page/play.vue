...
<script>
    ...
    import {addRecord, commentList, deleteComment,addComment,logAdd} from "@/api/getData";
        ...
        methods: {
          ...
          async reloadPage() {
            ...
            async handleDelete(index, row) {
                ...
                await logAdd({uid: this.uid, content:'删除评论'})
                this.getTableData();
            },
            async update() {
                const params = {
                ...
                await logAdd({uid: this.uid, content:'新增评论'})
                this.getTableData();
